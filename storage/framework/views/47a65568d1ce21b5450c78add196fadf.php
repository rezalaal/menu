<div dir="rtl" class="bg-gradient-to-b from-coral-from to-coral-to h-screen pb-48 flex flex-col items-center">
    ...
    <!--[if BLOCK]><![endif]--><?php if(auth()->user()): ?>
        <span class="farsi-number text-center w-full text-3xl pt-4"><?php echo e(auth()?->user()->username); ?></span>    
...
$__html = app('livewire')->mount($__name, $__params, 'lw-901364178-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-901364178-1', $__slots ?? [], get_defined_vars());
...
if (isset($__slots)) unset($__slots);
?>
</div><?php /**PATH /home/Happy/Projects/Laravel/coral/coral/resources/views/livewire/profile-page.blade.php ENDPATH**/ ?>