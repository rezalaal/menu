<div class="relative mx-4 md:px-4 mt-4"> 
    ...
    <input wire:model.live="search" class="border-1 font-dastnevis outline-0 placeholder-lime-900 border-lime-950 rounded-xl bg-white w-full text-xl outline-0 px-4 py-2 shadow-2xl text-lime-800" type="search" placeholder="جستجو"> 
...
?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH /home/Happy/Projects/Laravel/coral/coral/resources/views/livewire/search-input.blade.php ENDPATH**/ ?>