        ...
        <div class="flex flex-col items-center w-full pt-4">
            ...
            <!--[if BLOCK]><![endif]--><?php if($total > 0): ?>
                ...
                <div class="w-full max-w-sm px-4 mt-4 flex justify-between items-center text-lg">
                    ...
                    <span class="font-iransans-bold farsi-number"><?php echo e(number_format($total)); ?> <span class="font-dastnevis">تومان</span></span>
                </div>

                <div class="w-full max-w-sm px-4 mt-2 flex justify-between items-center text-lg">
                    <span class="font-dastnevis">میز:</span>
                    <span class="font-iransans-bold"><?php echo e($table); ?></span>
                </div>
