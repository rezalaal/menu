...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]--></div>   
    ...
    <input wire:model="mobile" class="placeholder-lime-900 font-dastnevis rounded-xl bg-gray-100 w-80  text-xl text-center outline-0 p-4 pt-4 shadow-2xl text-lime-900" dir="rtl" type="number" placeholder="شماره تلفن همراه">
...
</form><?php /**PATH /home/Happy/Projects/Laravel/coral/coral/resources/views/livewire/login-form.blade.php ENDPATH**/ ?>