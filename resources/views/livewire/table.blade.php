<div  wire:init="loadData" class="fixed w-full h-full bg-coral-body flex flex-col justify-center items-center">
    ...
    <div wire:loading.remove class="relative min-h-screen">
        <!-- ویدیو پس‌زمینه -->
        ...
        <div class="relative pb-16 font-iransans-regular min-h-screen flex flex-col justify-between items-center p-6">
            ...
            <div x-data="{ visible: false }" @click.away="visible = false" class="flex flex-col items-center mt-6 group">
                ...
                <!-- عنوان -->
                <span class="font-iransans-extrabold text-2xl pt-2 text-shadow text-coral text-center">
            {{ $settings['title'] }}
        </span>
        ...
        @endauth
            ...
            <!-- اطلاعات تماس -->
            <div class="w-full flex justify-center text-sm flex-wrap gap-6 mt-4 mb-4 text-coral">
                <!-- اینستاگرام -->
                <a href="https://instagram.com/{{ $settings['instagram'] }}" target="_blank" class="flex text-white no-underline hover:underline items-center transition-all">
                    <svg style="fill: #ccc" class="w-6"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  viewBox="0 0 50 50">
                ...
                <!-- تلفن -->
                <a href="tel:{{ $settings['mobile'] }}" class="flex text-white no-underline hover:underline items-center transition-all">
                    <svg style="fill: #ccc" class="w-6"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
