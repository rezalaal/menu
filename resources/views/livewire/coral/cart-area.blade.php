<div class="relative flex flex-col items-center justify-center mt-6" id="cart-icon">
    <div>
        <button    
            ...
            <span id="cart-number" class="farsi-number font-iransans-bold absolute left-2 top-1 text-[9px]">15</span>
        </button>        
    </div>
...
<script>    
    setInterval(() => {
        ...
        if (cartData) {
            cartNumberEl.innerText = JSON.parse(cartData).length;
        } else {
            cartNumberEl.innerText = 0;
        }
