...
>
    ...
    >
        ...
        <template x-for="item in items" :key="item.id">
            <div dir="rtl" class="flex items-center justify-between border-b py-2 gap-2">
                ...
                <div class="flex-1 flex flex-col justify-between text-right">
                    ...
                    <div class="farsi-number text-coral text-[11px] font-iransans-bold mb-1">
                        <span class="farsi-number font-iransans-bold" x-text="formatPrice(item.price * item.quantity)"></span> تومان
                    </div>

                    <div class="farsi-number font-iransans-bold text-[10px] text-gray-400">
                        تعداد: <span class="farsi-number font-iransans-bold" x-text="item.quantity"></span>
                    </div>
                </div>
            </div>
        </template>
