...
>
    @if($table && !$table->called_waiter)
        ...
        <button
            ...
            class="fixed flex justify-center items-center bottom-4 left-2 bg-coral text-white p-3 rounded-full shadow-lg hover:bg-orange-500 transition">
    ...
    @elseif($table && $table->called_waiter)
        <p class="fixed bottom-6 left-0 bg-coral/80 text-white text-sm md:text-base font-iransans rounded-tr-lg rounded-br-lg px-4 py-1 shadow-xl flex items-center gap-2 animate-fade-in transition-all duration-300">
